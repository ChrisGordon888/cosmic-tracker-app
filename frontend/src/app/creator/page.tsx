    ...
    const commandLinks = activeProject
        ? [
            ...
            },
            {
                ...
                meta: 'Singles · EPs · Albums',
                priority: 'secondary',
            },
            {
                label: 'Nexus',
                href: '/nexus',
                meta: 'Curated discovery',
                priority: 'secondary',
            },
        ]
        : [
            ...
            <section className="creator-console">
                    ...
                    <div className="creator-hero-copy">
                        ...
                        <p>
                            {activeProject
                                ...
                                : 'Capture music in your Library first, or create a Single, EP, Album, or other Release World when you already know the direction.'}
                        </p>
                ...
                <section className="creator-console-topline" aria-label="Creator stats">
                    <article>
                        ...
                        <p>Tracks captured in COSMIC.</p>
                    </article>

                    <article>
                        <span>Unsorted</span>
                        <strong>{unsortedTrackCount}</strong>
                        <p>Music waiting for a project — or happy without one.</p>
                    </article>
                ...
                <section className="creator-console-grid creator-console-grid-main">
                    ...
                    <article className="creator-console-panel">
                        <p className="creator-console-kicker">Release World Monitor</p>
                            ...
                            {projects.length > 0 ? (
                                ...
                                <article className="creator-project-card creator-project-card-empty">
                                    <div className="creator-project-card-body">
                                        ...
                                        <p>Create a Single, EP, Album, campaign, or other intentional world when the music has a direction.</p>
                        ...
                        <div className="creator-profile-card">
                            ...
                            <p>
                                {activeProfile?.tagline ||
                                    activeProfile?.bio ||
                                    'This profile anchors your Library, Release Worlds, featured project, and Nexus identity.'}
                            </p>
                        </div>
                    ...
                    <article className="creator-console-panel">
                        ...
                        <div className="creator-console-phases">
                            {[
                                {
                                    title: 'Capture',
                                    body: 'Upload ideas, rough drafts, demos, or finished songs into your Library.',
                                },
                                {
                                    title: 'Organize',
                                    body: 'Keep songs Unsorted until the right project, Realm, or direction becomes clear.',
                                },
                                {
                                    title: 'Develop',
