...
export default function Realm202() {
    ...
    const ensureTrialStarted = async (trialId: string, trialName: string) => {
        try {
            ...
            await refetch();
            alert(`${trialName} started.\nA deeper layer of The Veil is now open.`);
        } catch (error: any) {
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                            <div className="flex-1">
                                ...
                                <p className="text-secondary mb-4">
                                    ...
                                    begins here: the ability to see beyond the material world and sense what moves
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {trial2?.isComplete ? (
                                                    <>
                                                        <p className="text-sm text-secondary mb-3">
                                                            Release what you long for, let grasping dissolve, and find peace in the infinite now.
                                                        </p>
