    ...
    <>
      ...
      <div className="min-h-screen pb-32 realm-0-shell">
        <div className="container mx-auto px-4 py-8 max-w-6xl realm-0-container">
          ...
          <div className="glass-card realm-0-overview p-6 mb-8 fade-in prismatic-border" style={{ animationDelay: '0.1s' }}>
            <div className="flex flex-col lg:flex-row lg:items-start gap-6">
              <div className="flex-1">
                <h2 className="text-2xl font-display mb-3">∞ Realm Overview</h2>
                <p className="text-secondary mb-4">
                  InterSiddhi is the realm beyond realms — the source beneath all movement. It is where striving softens, separateness dissolves, and everything returns to balance, memory, and origin.
                </p>
          ...
          <div className="glass-card p-4 mb-8 fade-in realm-0-progression-toggle prismatic-border" style={{ animationDelay: '0.15s' }}>
            <button
            ...
            >
              <div>
                ...
                <p className="text-sm text-muted mt-1">
                  This layer is still being refined. The main focus of InterSiddhi is music and emotional navigation.
                </p>
              </div>
          ...
          {completedTrialsCount >= 3 && (
            <div className="glass-card p-8 mb-8 text-center fade-in prismatic-border realm-0-complete-card">
              ...
              <p className="text-secondary mb-4 max-w-2xl mx-auto">
                All realms explored. All trials conquered. The journey never ends — it only transforms.
              </p>
              <Link href="/nexus">
                <button className="btn-primary prismatic-btn">RETURN TO THE NEXUS →</button>
              </Link>
            </div>
          )}
