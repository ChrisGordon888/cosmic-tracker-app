...
import {
  GET_ME, COMPLETE_TRIAL_STEP, START_TRIAL, VISIT_LOCATION, UNLOCK_REALM,
} from '@/graphql/realms';
...
export default function Realm55() {
  ...
  const towerUnlocked = !!trial1;   // Tower of Ascension unlocks when Trial 1 starts
  const arenaUnlocked = !!trial2;   // Arena of Kings unlocks when Trial 2 starts (trial1 done)
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="glass-card p-8 mb-8 fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-lg text-secondary mb-4">
              Skybound City floats above the clouds — a gleaming metropolis where thought becomes form
              and intention shapes reality. This is the realm of kings, warriors, and those who command
              their destiny.
            </p>
            <p className="text-secondary mb-6">
              Here you unlock <strong>Manifestation Mastery</strong>: the power to bend reality to your
              will, to materialise your visions, and to command energy with absolute authority.
            </p>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-6">
              ...
              {/* Trial 1: Sovereignty — location (tower) + 2 puzzles */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="stat-bar">
                        <div className="stat-bar-fill realm-55-bar"
                    ...
                    {trial1?.isComplete ? (
                      ...
                      <button className="btn-primary"
                        onClick={() => handleStartTrial('trial-sovereignty', 'Trial of Sovereignty')}>
                        BEGIN TRIAL →
                      </button>
                      ...
                      <>
                        ...
                        <button className="btn-secondary"
                          onClick={() => locationsSectionRef.current?.scrollIntoView({ behavior: 'smooth' })}>
                          GO TO LOCATIONS ↓
                        </button>
                      </>
                      ...
                      <button className="btn-primary"
                        onClick={() => claimTrialStep('trial-sovereignty', 'Trial of Sovereignty')}>
                        CLAIM STEP (+XP)
                      </button>
                      ...
                      <TrialPuzzle
                        ...
                        puzzle={REALM_55_PUZZLES['trial-sovereignty'].steps[trial1.stepsCompleted - 1]}
                        onSolved={() => claimTrialStep('trial-sovereignty', 'Trial of Sovereignty')}
                      />
                    ) : null}
                  </div>
                </div>
              ...
              {/* Trial 2: Power Manifestation — location (arena) + 2 puzzles */}
              <div className={`quest-card fade-in ${!trial1?.isComplete ? 'opacity-50' : ''}`}
                    ...
                    {!trial1?.isComplete ? (
                      ...
                      <>
                        ...
                        {trial2?.isComplete ? (
                          ...
                          <button className="btn-primary"
                            onClick={() => handleStartTrial('trial-power-manifestation', 'Trial of Power Manifestation')}>
                            BEGIN TRIAL →
                          </button>
                          ...
                          <button className="btn-primary"
                            onClick={() => claimTrialStep('trial-power-manifestation', 'Trial of Power Manifestation')}>
                            CLAIM STEP (+XP)
                          </button>
                          ...
                          <TrialPuzzle
                            ...
                            puzzle={REALM_55_PUZZLES['trial-power-manifestation'].steps[trial2.stepsCompleted - 1]}
                            onSolved={() => claimTrialStep('trial-power-manifestation', 'Trial of Power Manifestation')}
                          />
                        ) : null}
                      </>
                    )}
              ...
              {/* Trial 3: Divine Authority — 2 puzzles, no location gate */}
              <div className={`quest-card fade-in ${!trial2?.isComplete ? 'opacity-50' : ''}`}
                    ...
                    {!trial2?.isComplete ? (
                      ...
                      <>
                        ...
                        {trial3?.isComplete ? (
                          ...
                          <button className="btn-primary"
                            onClick={() => handleStartTrial('trial-divine-authority', 'Trial of Divine Authority')}>
                            BEGIN TRIAL →
                          </button>
                          ...
                          <TrialPuzzle
                            ...
                            puzzle={REALM_55_PUZZLES['trial-divine-authority'].steps[trial3.stepsCompleted]}
                            onSolved={() => claimTrialStep('trial-divine-authority', 'Trial of Divine Authority')}
                          />
                        ) : null}
                      </>
                    )}
          ...
          <div ref={locationsSectionRef} id="locations-section" className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Tower of Ascension — locks until Trial 1 starts */}
              <div className={`realm-portal fade-in ${towerUnlocked ? 'unlocked' : 'opacity-50'}`}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      disabled={!towerUnlocked || hasVisited('tower-of-ascension')}
                    >
                      {hasVisited('tower-of-ascension') ? '✅ EXPLORED'
                        : !towerUnlocked ? '🔒 LOCKED'
                        : 'EXPLORE →'}
                    </button>
                  </div>
                </div>
              ...
              {/* Arena of Kings — locks until Trial 2 starts */}
              <div className={`realm-portal fade-in ${arenaUnlocked ? 'unlocked' : 'opacity-50'}`}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      disabled={!arenaUnlocked || hasVisited('arena-of-kings')}
                    >
                      {hasVisited('arena-of-kings') ? '✅ EXPLORED'
                        : !arenaUnlocked ? '🔒 LOCKED'
                        : 'EXPLORE →'}
                    </button>
                  </div>
                </div>
          ...
          {completedTrialsCount >= 3 && (
            <div className="glass-card p-8 mb-8 text-center fade-in"
              ...
              <p className="text-secondary mb-6 max-w-2xl mx-auto">
                You have mastered Power &amp; Manifestation. The Astral Bazaar awaits — where wisdom
                meets commerce and time bends to the bold.
              </p>
              <Link href="/realms/44">
