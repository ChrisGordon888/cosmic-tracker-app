...
export default function FindYourRealmPage() {
  ...
  const getModeDescription = () => {
    ...
    if (experienceMode === 'stay') return recommendedRealm.stayDescription;
    if (experienceMode === 'move-through') return recommendedRealm.moveThroughDescription;
    return recommendedRealm.shiftDescription;
  };
          ...
          {!showResult ? (
            ...
            <div className="glass-card p-8 fade-in">
              ...
              <div className="glass-card p-6 mb-8">
                ...
                >
                  <p className="text-sm text-secondary">{getModeDescription()}</p>
                </div>
              </div>
