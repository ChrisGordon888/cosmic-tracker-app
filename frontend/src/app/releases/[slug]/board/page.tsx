                        ...
                        <div className="signal-board-style-row" aria-label="Starter board color">
                            {colorOptions.map((option) => (
                                <button
                                    key={option.value}
                                    type="button"
                                    className={`signal-board-swatch signal-board-swatch-${option.value} ${boardColor === option.value ? 'is-active' : ''
                                        }`}
                        ...
                        <div className="signal-board-style-row" aria-label="Sticky note color">
                            {colorOptions.map((option) => (
                                <button
                                    key={option.value}
                                    type="button"
                                    className={`signal-board-swatch signal-board-swatch-${option.value} ${selectedColor === option.value ? 'is-active' : ''
                                        }`}
            ...
            <section className="signal-board-mobile-list" aria-label="Signal board artifact list">
                {artifacts.map((artifact) => (
                    <article
                        ...
                        className={`signal-board-pin signal-board-pin-${artifact.kind} signal-board-pin-color-${artifact.color ?? 'cream'
                            } signal-board-pin-size-${artifact.size ?? 'md'}`}
                    >
                        <p className="signal-board-pin-eyebrow">{artifact.eyebrow}</p>
                        <h2>{artifact.title}</h2>
